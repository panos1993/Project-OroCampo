namespace OroCampo.DatabaseHandler
{
    ...
    {
        public async Task<Guid> SaveProductCategory(ProductCategory productCategory, string connectionString)
        {
        ...
        public async Task<ProductCategory> GetProductCategory(Guid productCategoryId, string connectionString)
        {
            // We create an sql connection 
            using (var sqlConnection = new SqlConnection(connectionString))
            {
        ...
        public async Task<List<ProductCategory>> GetProductCategories(string connectionString)
        {
            // We create an sql connection 
            using (var sqlConnection = new SqlConnection(connectionString))
            {
